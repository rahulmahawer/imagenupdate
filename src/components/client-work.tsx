...
export const products: Product[] = [
  {
    ...
    original: "/images/ARH-119.jpg",
    generated: [
      { suffix: "_1", label: "Hero — front view", url: "/images/ARH-119_1.png" },
      { suffix: "_2", label: "Angled view", url: "/images/ARH-119_2.png" },
      { suffix: "_3", label: "Detail — material & edge", url: "/images/ARH-119_3.png" },
      { suffix: "_4", label: "Lifestyle 01", url: "/images/ARH-119_4.png" },
      { suffix: "_5", label: "Lifestyle 02", url: "/images/ARH-119_5.png" },
      { suffix: "_6", label: "Dimension drawing", url: "/images/ARH-119_6.png" },
    ],
  },
];
